...
{"drivers":
  [
    ...
    },
    {
      ...
      version:7,
      listeners : {
        YamahaStatus : {type:"http-get", command:"http://192.168.1.24/YamahaExtendedControl/v1/main/getStatus", queryresult : "$.data", 
          evalwrite : [ 
           {variable : "VolumePlayed",value : "JSON.parse($Result).volume"},
        ]}
      },
      variables:{
        MyStatus:"",
      ...
      sliders:{
        "VOLUME": {label:"", min : 0, max : 161, unit : "db", type:"http-get", command:"http://192.168.1.24/YamahaExtendedControl/v2/main/setVolume?volume=", queryresult:"$.volume", listen:"VolumePlayed"},
      },
      directories:{
        "INPUT": {label:"", feeders: {
